...
func (t *buyer_seller) createOrder(APIstub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	var comAsset = Order_Asset{Order_Id: "Order" + strconv.Itoa(orderCounter), Order_Receiver: args[1], Order_ProductId: args[2], Order_Quantity: i1, Order_Status: "PLACED", Order_CreationDate: txTimeAsPtr}
...
func (t *buyer_seller) updateOrderStatus(APIstub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	orderAsset.Order_Status = args[2]
